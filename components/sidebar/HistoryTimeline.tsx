...
import { FiGitCommit, FiFileText } from "react-icons/fi";
        ...
        {history.map((item) => {
          ...
          return (
            <div key={item.id} className="relative pl-6 group">
              {/* Timeline diff icon */}
              <div className="absolute -left-[9px] top-1 h-4 w-4 bg-[#151922] flex items-center justify-center transition duration-150 group-hover:scale-110">
                <FiGitCommit className="h-3.5 w-3.5 text-[#6B7280] group-hover:text-[#3B82F6] transition duration-150" />
              </div>
              ...
              <div
                ...
                className="rounded-xl border border-white/[0.06] bg-[#1A1F29] p-3 transition duration-150 hover:border-white/[0.12] hover:bg-[#1F2633] cursor-pointer"
              >
